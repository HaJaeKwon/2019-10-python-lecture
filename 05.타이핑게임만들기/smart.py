...
WORD_LIST = [
    "남박사의 파이선 100% 실전 프로그래밍 강좌",
    "파이썬에서 ord() 함수는 유니코드 값을 알아오는 함수로 10진수 값을 리턴합니다.",
    "chr(x)는 x에 유니코드 10진수 값ㅇ르 입력하면 해당하는 문자를 리턴합니다.",
    "UTF-8은 유니코드 10진수 값을 입력하면 해당하는 문자를 리턴합니다.",
